...
namespace LIB2.DAL
{
    internal class PNKDAL
    {
        ...
        {
            string sql = $@"SELECT P.MaPhieuNhapKho, P.MaNVLap, NV1.TenNV AS TenNVLap, P.MaNVDuyet, NV2.TenNV AS TenNVDuyet, P.NgayLap, P.NgayDuyet, P.NguonNhap 
                            FROM {TableName} P 
        ...
        public static void DuyetPNK(string maPNK, string maNVDuyet, DateTime ngayDuyet)
        {
            string sqlUpdate = "UPDATE " + TableName + " SET MaNVDuyet = @MaNVDuyet, NgayDuyet = @NgayDuyet WHERE MaPhieuNhapKho = @MaPNK";
            SqlParameter[] updateParams =
            {
