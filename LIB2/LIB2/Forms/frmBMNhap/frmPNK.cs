...
namespace LIB2.Forms
{
    public partial class frmPNK : MaterialForm
    {
        ...
        private void InitializeListView()
        {
            ...
            listViewPNK.Columns.Add("TrangThai", "Trạng thái duyệt");
        }
        ...
        private void AdjustColumnWidth()
        {
            ...
            listViewPNK.Columns[8].Width = col9Width;
        }
        ...
        private void btnDuyet_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                PNKDAL.DuyetPNK(maPNK, maNVDuyet, ngayDuyet, true);
        ...
        private void btnKhongDuyet_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                PNKDAL.KhongDuyetPNK(maPNK, maNVDuyet, false);

                Functions.HandleInfo("Không duyệt phiếu nhập kho thành công");
                LoadData();
                LoadDataCT("");
            ...
            {
                Functions.HandleError("Lỗi khi không duyệt phiếu nhập kho: " + ex.Message);
            }
        }
